...
namespace p3ppc.guaranteedItemDrops.NuGet.templates.defaultPlus;
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Guaranteed Item Drops] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Guaranteed Item Drops] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Guaranteed Item Drops] {message}", System.Drawing.Color.Red);
    }
